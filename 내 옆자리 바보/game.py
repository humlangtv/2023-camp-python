...
pygame.display.set_caption("하찮은 게임") # 게임 이름 설정

# 배경 이미지 불러오기
background = pygame.image.load("C:\\Users\\저스트필\\Desktop\\내 옆자리 바보\\background duck.png")

# 캐릭터 불러오기

character = pygame.image.load("C:\\Users\\저스트필\\Desktop\\내 옆자리 바보\\duck character.png")
...
enemy = pygame.image.load("C:\\Users\\저스트필\\Desktop\\내 옆자리 바보\\enemy1.png")
